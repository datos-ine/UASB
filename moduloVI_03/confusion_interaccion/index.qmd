...
- A diferencia de la confusión, que es un sesgo o distorsión que se debe controlar y corregir, el fenómeno de interacción no debe *"controlarse"*, sino que debe ser descriptto, del modo más exhaustivo que sea posible, porque enriquece al análisis del objeto de estudio.
